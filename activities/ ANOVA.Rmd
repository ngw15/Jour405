...
The average score is highest at private colleges then public and lastly community, which just shows the competitiveness of each category of schools. The max scores for public and private colleges are the maximum score for SAT's while the community college is a little bit lower. 
...
1. Yes, there is significant difference in SAT scores across college types and we know this because the p-value is significantly small. In comparison the f-value is huge. 
2. Private versus community colleges differ from each other the most with private schools having on average more than 366 points higher than community colleges. 
3. By 366.96 points specifically. 

HL: Private Colleges have a soaring lead in SAT scores compared to community colleges

According to a study, researchers found that private colleges on average have a little over 366 SAT points above community colleges with averages of 1435.026 for private schools and 1068.070 for community colleges. Public colleges land in between the two but leaning more towards private schools with an average of 1360.621, which is 292.55 SAT points higher than community colleges but 74.4 points lower than private colleges. 
