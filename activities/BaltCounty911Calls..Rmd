...
Around seven to 12 overdose calls happen a day on average while there are unusual numbers that are really low and really high. If I had to draw a horizontal line that would highlight unusual days, they would be at all of the points above 20 calls a day and all the points below 5 points a day. 
...
I had a much wider range between the unusually high and unusually low points. My range was between 5 and 20 calls. This data's range is 7 and 11 calls. I was guessing an estimate and was a little off. 
...
I would describe the day with the highest z-score without using z-score is that Saturdays had an unusually high number of overdose-related 911 calls compared to the other days of the week. Saturdays had an average of 11.35 calls while every other day of the week had less than 11 average calls. 
...
Based on our z-score analysis, March to May and August had the highest number of overdose related 911 calls. We can also see that Saturdays have the highest average of overdose related 911 calls compared to other days of the week. The highest clustered days surrond weekends and tend to spike on holidays like the fourth of July. My next steps would be to see how many officers are employed on weekends and holidays compared to other days of the week. Possible story ideas could be to see if the weather or holidays have an impact on overdoses. 
