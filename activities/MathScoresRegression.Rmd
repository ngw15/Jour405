...
Based on what I see here, there doesn't seem to be a relationship between FARMS and math test scores. It looks like only 50% of students use FARMS and of those students a range met or exceeded math test expectations. 
...
I think this model is worth using if we can figure out math scores or FARMS percentages just by having one or the other. It tells us that students math scores are dependent on FARMS, which kind of makes sense because having a healthy breakfast or lunch can increase test scores and students focus. 
...
The school with the largest difference is White Marsh elementary school with a predicted score of 71.9% and an actual score of 26.1% that met or exceeded math test scores expectations. Only 11.4% of students use FARMS. This shows that the lower the amount of FARMS students, the lower the math scores are going to be. 
...
I would make a story that this school board member lied about their statement and that fewer kids on free and reduced meals means that standardized math test scores will be lower based on the model's results. Using White Marsh Elementary School as an example, with only about 11% of students using free and reduced meals, only 26% of students met or exceeded standardized math test scores. 
