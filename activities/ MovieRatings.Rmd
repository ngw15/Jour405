...
The latter set is only slightly different than the former set. The five star rated movies are the most different with 160 being the expected amount and 145 being the observed. The next biggest difference was with two star rated movies with 20 being expected and then 32 being observed. 
...
We reject the null hypothesis and conclude that the observed frequencies are significantly different from the expected frequencies because the chi-square statistic, 9.9521 is greater than the critical value of 9.487729. 
