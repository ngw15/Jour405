...
car_thefts %>% 
  ...
  geom_vline(aes(xintercept=mean(count)), color ="red", linetype="dashed", size=1)+ geom_vline(aes(xintercept=mean(count)-sd(count)), color ="blue", linetype="dashed", size=1)+
...
It's slighlty skewed left (you keep saying right in class but it's left...).There's more than average thefts happening. One standard deviation below the mean is significantly less than one standard deviation above the mean.  
