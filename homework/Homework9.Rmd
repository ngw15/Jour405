...
just looking in the data, the test scores have improved. The average mean before was 72.6. All of the test scores in the data frame are higher than 72.2 which means automatically the new average mean is going to be higher than that. 
...
The mean went up and the standard deviation went down which means that the average test scores did go up. I would wonder if this is a one year type of thing, so I would look at the data for the year after that too. I wonder what influenced these new scores? Did the instructors and schools new before hand that we were taking the data and do more to help the scores? What would the scores be if the instructors and schools didn't know? 
...
reading scores across (insert schools name) classrooms 
...
**Hypotheses:**
Null: The new reading program testscores 
Alternative: The new reading program testscores
...
The p-value tells us if the null hypothesis is happening by chance or influenced by some other factor. In this case, there's a low chance that the improved scores are random. 
...
A study finds that District’s New Reading Program Boosts Third-Grade Scores

A recent study of third-grade reading tests showed that the new reading program significantly improved test scores.The average score rose from 72.6 to 75.75 with other tests showing a low chance of these improvements happening by chance. 

### Reflection Question 6:
What metrics or outcomes beyond test scores might be important to track for assessing reading performance?
Other metrics that would be important to track are reading comprehension, feedback from teachers and instructors in the program, vocabulary development and retention, fluency improvement 
