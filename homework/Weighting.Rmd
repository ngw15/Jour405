...
The range is .23 to 3.04. 

2. What does it mean when a respondent has a weight of 0.23? What about 3.04?
A weight of .23 means that the respondent is overly represented and counts for only 23% of a person to correct this. A weight of 3.04 means the respondent is underrepresented and so their responses are scaled up to count for 3.04 worth of opinion.  


3. Why might some respondents be weighted more heavily than others?
Some respondents might be weighted more heavily than others because different groups that are underrepresented in the survey compared to the general population. For example people of minority races, ethnicity or genders or people with lower incomes or lower education levels. 
...
The category with the biggest difference between weighted and unweighted results are the rarely/never voters with a -3.6 percentage point change.

2. How might these differences affect reporting on likely voter turnout?
These differences could have a significant impact on how voter turnout is seen in a news story. The estimates without reflecting the general population would be off. All the data used in the story could be off and completely wrong. 
...
I think these differences happen because some groups are generally just smaller and some groups don't respond to surveys as much. 
 never vote may be less likely to take surveys, so those who do respond are not typical of the group. These groups tend to be underrepresented in data, while groups that are bigger and/or always fill out surveys are overrepresented. 
