...
Yes, I think the differences between the expected and observed frequencies are meaningful because two grade categories have a difference of 20, which is a lot. The other catergories have changes of 5-10 students which isn't as bad as 20. 
...
The chi-square value is 11.667 and the critical value is 9.488, meaning that we reject the null hypothesis since the chi-square value is greater than the critical value. The p-value, .020 is lower than the .5 level of significance, which also means we reject the null hypothesis. 
...
The notable discrepancies are with the A's, C's and F's. Twenty more students got A than were expected while 20 fewer students got C's than expected. Ten fewer students got an F than expected. Some questions I would ask are:


Has there been a change in grading policy? A change in teaching curriculum? 
Are instructors encouraged to be more lenient?
Are there any new support programs that might help grades?
