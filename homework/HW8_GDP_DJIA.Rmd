...
There is a very strong relationship between the DJIA and GDP. The correlation coefficient is 0.9531058, which is really close to 1, indicating a strong relationship. On the graph, all of the plot points are near the coefficient line, which also shows a very strong relationship.  
