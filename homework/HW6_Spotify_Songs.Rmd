...
The data is skewed left with the mean being to the left and most of the information being to the left of the mean. I suppose that means that most of the songs are danceable, which is good for those artists and spotify. I would look into what the genre is of those songs and then pitch that as a story. I would also look at what makes a song danceable. Is it the genre? Tempo? Then I would look at the popularty of those songs compared to the lower ranked songs. 
